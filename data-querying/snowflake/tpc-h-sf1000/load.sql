...
ALTER WAREHOUSE Load_WH_TPC_H_SF1000 RESUME;

-- Select database for table import
use database TPC_H_SF1000;
...
COPY INTO region
  FROM s3://tpc-h-dataset/sf1000/region/
...
COPY INTO nation
  FROM s3://tpc-h-dataset/sf1000/nation/
  CREDENTIALS = (AWS_KEY_ID='<aws-iam-key>' AWS_SECRET_KEY='<aws-iam-key-secret>')
  FILE_FORMAT = (TYPE = CSV FIELD_DELIMITER = '|' SKIP_HEADER = 0 ERROR_ON_COLUMN_COUNT_MISMATCH = false);


COPY INTO customer
  FROM s3://tpc-h-dataset/sf1000/customer/
  CREDENTIALS = (AWS_KEY_ID='<aws-iam-key>' AWS_SECRET_KEY='<aws-iam-key-secret>')
  FILE_FORMAT = (TYPE = CSV FIELD_DELIMITER = '|' SKIP_HEADER = 0 ERROR_ON_COLUMN_COUNT_MISMATCH = false);


COPY INTO lineitem
  FROM s3://tpc-h-dataset/sf1000/lineitem/
  CREDENTIALS = (AWS_KEY_ID='<aws-iam-key>' AWS_SECRET_KEY='<aws-iam-key-secret>')
  FILE_FORMAT = (TYPE = CSV FIELD_DELIMITER = '|' SKIP_HEADER = 0 ERROR_ON_COLUMN_COUNT_MISMATCH = false);


COPY INTO orders
  FROM s3://tpc-h-dataset/sf1000/orders/
  CREDENTIALS = (AWS_KEY_ID='<aws-iam-key>' AWS_SECRET_KEY='<aws-iam-key-secret>')
  FILE_FORMAT = (TYPE = CSV FIELD_DELIMITER = '|' SKIP_HEADER = 0 ERROR_ON_COLUMN_COUNT_MISMATCH = false);


COPY INTO part
  FROM s3://tpc-h-dataset/sf1000/part/
  CREDENTIALS = (AWS_KEY_ID='<aws-iam-key>' AWS_SECRET_KEY='<aws-iam-key-secret>')
  FILE_FORMAT = (TYPE = CSV FIELD_DELIMITER = '|' SKIP_HEADER = 0 ERROR_ON_COLUMN_COUNT_MISMATCH = false);


COPY INTO partsupp
  FROM s3://tpc-h-dataset/sf1000/partsupp/
  CREDENTIALS = (AWS_KEY_ID='<aws-iam-key>' AWS_SECRET_KEY='<aws-iam-key-secret>')
  FILE_FORMAT = (TYPE = CSV FIELD_DELIMITER = '|' SKIP_HEADER = 0 ERROR_ON_COLUMN_COUNT_MISMATCH = false);


COPY INTO supplier
  FROM s3://tpc-h-dataset/sf1000/supplier/
  CREDENTIALS = (AWS_KEY_ID='<aws-iam-key>' AWS_SECRET_KEY='<aws-iam-key-secret>')
  FILE_FORMAT = (TYPE = CSV FIELD_DELIMITER = '|' SKIP_HEADER = 0 ERROR_ON_COLUMN_COUNT_MISMATCH = false);

-- Shutdown warehouse cluster
ALTER WAREHOUSE Load_WH_TPC_H_SF1000 SUSPEND;